...
$string['ATAddConst_generic'] = 'Sie haben eine weitere Konstante eingefügt, aber Sie haben sie nicht einfach nur hinzugefügt!';
...
$string['ATAntidiff_STACKERROR_Opt'] = 'Die Antwortüberprüfung ist fehlgeschlagen: Bitte kontaktieren Sie Ihre/n Trainer/in. Es gibt ein Problem mit den Optionen, die der Antwortüberprüfung ATAntidiff übergeben werden.';
...
$string['ATSingleFrac_var'] = 'Die Variablen in Ihrer Antwort unterscheiden sich von denen in der Frage. Bitte überprüfen Sie sie.';
...
$string['addanothernode'] = 'Weitere(n) Knoten hinzufügen';
...
$string['analyzeresponsesnotes'] = 'Bitte beachten Sie: (1) Hier sind alle Antworten von Teilnehmer/innen zu jedem Testversuch enthalten, (2) alle Versionen der Frage sind enthalten.';
...
$string['basicreportnotes'] = 'Häufigkeit der Antworthinweise für jeden PRT, unabhängig davon, welche Variante verwendet wurde';
$string['basicreportnotessplit'] = 'Häufigkeit der Antworthinweise für jeden PRT, durch | getrennt, unabhängig davon, welche Variante verwendet wurde';
$string['basicreportraw'] = 'Rohdaten';
$string['basicreportvariants'] = 'Rohe Eingaben und PRT-Antworthinweise nach Variante';
...
$string['castext_debug_no_vars'] = 'Diese Frage hat keine Aufgabenvariablen zum Debuggen! Zeigen Sie Aufgabenvariablen im Fragetext an und Feedbackvariablen im Feedback in einzelnen Knoten';
...
$string['chatintro2'] = '"Änderungen in der Frage speichern" überschreibt die Aufgabenvariablen und das allgemeine Feedback der aktuellen Version der Frage. Ein Klick auf "Zum Bearbeitungsformular senden" speichert Ihre Änderungen nicht direkt. Sie gelangen damit zum Bearbeitungsformular für die Version der Frage, die oben auf dieser Seite angegeben ist. Von dort aus können Sie Ihre Änderungen als neue Version der Frage speichern. Verwenden Sie "Sende zum CAS" unmittelbar vor "Zum Bearbeitungsformular senden", um die aktuelle Version zu aktualisieren.';
...
$string['defaulttestfail'] = 'Der Standard-Test führt bei Verwendung der Musterlösungen nicht zu einer Punktzahl von 1.';
$string['defaulttestpass'] = 'Der Standard-Test führt bei Verwendung der Musterlösungen zu einer Punktzahl von 1.';
...
$string['dependenciesintro_desc'] = 'Der<a href="{$a->link}">Abhängigkeitsprüfer</a> findet Fragen, die Abhängigkeiten wie JSXGraph oder die Einbindung von externem Maxima-Code aufweisen.';
...
$string['equivmixedreasoning'] = 'Beim Umformen sollten Sie Schritt für Schritt entweder (i) Ausdrücke umschreiben oder (ii) Gleichungen umschreiben. Sie scheinen beides zu vermischen, was nicht zulässig ist.';
...
$string['healthcheckconnectunicode'] = 'Versuch, Unicode an das CAS zu senden';
$string['healthcheckcreateimage'] = 'Maxima-Image erstellen';
$string['healthcheckfail'] = 'Der Funktionscheck hat schwerwiegende Probleme festgestellt.  Bitte lesen Sie die folgenden Diagnoseinformationen für weitere Details.';
$string['healthcheckfaildocs'] = 'Detaillierte Hinweise und Tipps zur Fehlerbehebung finden Sie in der Dokumentation unter <a href="{$a->link}">Installation > Testing installation</a>.';
...
$string['healthcheckgeogebraintro'] = 'Unten sollten eine GeoGebra-Grafik und ein Eingabefeld zu sehen sein. Interaktionen mit der Grafik sollten sich auf die Eingabe auswirken.';
$string['healthcheckjsxgraph'] = 'JSXGraph-Binding und MathJax';
$string['healthcheckjsxgraphintro'] = 'Unten sollten ein Diagramm und ein Eingabefeld zu sehen sein. Interaktionen mit der Grafik sollten sich auf das Eingabefeld auswirken und umgekehrt. Ist dies nicht der Fall, liegen Probleme mit den JavaScript-Bibliotheken oder ihrer Ausführung vor. In der Grafik sollte außerdem eine mit MathJax gerenderte LaTeX-Formel sichtbar sein. Ist dies nicht der Fall, blockieren Sie möglicherweise den Zugriff auf bestimmte Elemente und müssen Firewalls, Proxys usw. anpassen. Wenn Sie eine geschlossene Installation betreiben, versuchen Sie, die Remote-Adressen in <code>vle_specific.php</code> anzupassen. Die Grafik (sofern sie funktioniert) basiert auf <a href="https://jsxgraph.org/share/example/differential-equations">diesem Beispiel</a>.';
...
$string['healthcheckmathsmathjaxloc'] = 'Sie verwenden scheinbar eine lokale Kopie von MathJax und müssen sicherstellen, dass Ihr Webserver die richtigen CORS-Header für die MathJax-Dateien sendet. Weitere Informationen finden Sie in der Dokumentation zum Testen der Installation.';
$string['healthcheckmaximaavailable'] = 'Auf diesem Server verfügbare Maxima Versionen';
$string['healthcheckmaximalocal'] = 'Inhalte der maximalocal-Datei';
...
$string['healthcheckproxysettings'] = '<strong>Warnung:</strong> Moodle ist so konfiguriert, dass es einen Proxy-Server verwendet, aber Aufrufe an Maxima umgehen diese Einstellung. Wechseln Sie die Plattform von "server" zu "Server (via Proxy)", um Aufrufe über den Proxy-Server zu leiten, oder fügen Sie den Maxima-Server zu $CFG->proxybypass hinzu, um die Umgehung explizit festzulegen. STACK sollte vorerst weiterhin funktionieren, auch wenn Sie keine Änderung vornehmen, aber die Proxy-Einstellungen von Moodle werden in einer späteren Version durchgesetzt.';
...
$string['healthchecksstackmaximaversionfixoptimised'] = 'Bitte <a href="{$a->url}">erstellen Sie Ihre optimierte Maxima-Ausführungsdatei neu</a>.';
...
$string['healthchecksstackmaximawarning'] = 'WARNUNG: Die verwendete Version der STACK-Maxima-Bibliotheken stimmt nicht mit der erwarteten Version überein. Bitte besuchen Sie die STACK-Funktionscheck-Seite, um die Probleme zu beheben.';
...
$string['healthuncachedstack_CAS_trigsimp'] = 'Die Funktion "trigsimp" funktioniert nicht. Möglicherweise müssen Sie auch das Paket "maxima-share" auf Ihrem System installieren?';
...
$string['mustconfirm'] = 'Es gibt Änderungen, die Sie bestätigen müssen.';
...
$string['questionvariablevalues'] = 'Werte der Aufgabenvariablen';
...
$string['runtimeerror'] = 'Diese Frage führte zu einem unerwarteten internen Fehler.';
...
$string['settingcaspreparse'] = 'Den gesamten Code vor dem Senden an Maxima vorab parsen.';
$string['settingcaspreparse_desc'] = 'Wir empfehlen, den gesamten Code in Fragen, Variablen usw., selbst wenn er von vertrauenswürdigen Lehrenden stammt, vorab auf potenziell schädliche Muster zu überprüfen. Dies ist besonders wichtig, wenn importierte Fragen aus bekannten Quellen übernommen werden.  Es ist jedoch möglich, dass es beim Pre-Parsen zu einem Timeout kommt, und es wäre notwendig, diese Prüfung (vorübergehend) zu deaktivieren, um aus einer potenziellen Sackgasse herauszukommen. Dieser Code befindet sich noch in der Test- und Entwicklungsphase und diese Einstellung wird in zukünftigen Versionen entfernt, um sicherzustellen, dass dieses Pre-Parsing immer angewendet wird.';
$string['settingcaspreparse_false'] = 'Nicht vorab parsen (nicht empfohlen)';
$string['settingcaspreparse_true'] = 'Immer vorab parsen';
...
$string['stackBlock_geogebra_link_help'] = 'Möchten Sie dieses Material bearbeiten? Wenn es sich um Ihr eigenes GeoGebra-Material auf geogebra.org handelt, können Sie es bearbeiten. Wenn es sich nicht um Ihr GeoGebra-Material handelt, müssen Sie das Material zunächst von geogebra.org kopieren. Anschließend müssen Sie das Material veröffentlichen und den Wert "material_id" unten im Fragetext bearbeiten.';
$string['stackBlock_geogebra_overdefined_dimension'] = 'Bei der Festlegung des Seitenverhältnisses für das GeoGebra-Applet sollte man nur die Breite oder die Höhe festlegen, nicht beides.';
$string['stackBlock_geogebra_param'] = 'Der GeoGebra-Block unterstützt in diesem Zusammenhang nur diese Parameter: {$a->param}.';
$string['stackBlock_geogebra_ref'] = 'Der GeoGebra-Block unterstützt nur Verweise auf Eingabefelder, die im selben CASText-Abschnitt vorhanden sind. "{$a->var}" existiert hier nicht.';
$string['stackBlock_geogebra_settingdefaultoptions'] = 'GeoGebra Einstellungen in STACK';
$string['stackBlock_geogebra_settingdefaultoptions_desc'] = 'Die Dokumentation zur Verwendung von GeoGebra in STACK finden Sie unter Specialist_tools/GeoGebra/';
$string['stackBlock_geogebra_underdefined_dimension'] = 'Bei der Festlegung des Seitenverhältnisses für das GeoGebra-Applet muss entweder die Breite oder die Höhe der Grafik angegeben werden.';
...
$string['stackBlock_geogebrabaseurl_help'] = 'Hier kann ein benutzerdefinierter Link hinzugefügt werden, falls Sie GeoGebra-Skripte auf einem eigenen Server hosten. Wenn Sie lediglich eine bestimmte GeoGebra-Version verwenden möchten, verwenden Sie: https://www.geogebra.org/apps/5.0.498.0/web3d (z. B. für Version 5.0.498.0)';
...
$string['stackBlock_jsxgraph_ref'] = 'Der JSXGraph-Block unterstützt nur Verweise auf Eingabefelder, die im selben CASText-Abschnitt vorhanden sind. "{$a->var}" existiert hier nicht.';
...
$string['stackBlock_jsxgraph_unknown_style'] = 'Unbekannter JSXGraph-Style: <code>{$a->style}</code>.';
...
$string['stackBlock_parsons_contents'] = 'Der Inhalt eines Parsons-Blocks muss ein JSON der Form {#stackjson_stringify(steps)#} sein, wobei \'steps\' ein zweidimensionales Maxima-Array mit Key-Value-Paaren ist, oder der Form {\'steps\' : {#stackjson_stringify(steps)#}, \'options\' : {JSON mit Sortable-Optionen}, \'header\' : [Liste der Überschriften], \'available_header\' : \'String, der die Überschrift für die Liste der verfügbaren Elemente enthält\', \'index\' : [Liste, die den Index enthält]}, wobei die Keys \'options\', \'header\', \'available_header\' und \'index\' optional sind. Alternativ darf der Inhalt des Parsons-Blocks reine JSON-Äquivalente enthalten. Wenn Sie reines JSON im Parsons-Block verwenden, werden numerische Keys nicht unterstützt, da es Probleme mit dem Neusortieren gibt. Nutzen Sie daher bitte beschreibende Tags. Beachten Sie, dass alle Schritte Strings sein müssen. Sehen Sie sich für Details dazu https://docs.stack-assessment.org/en/Authoring/Parsons/ an.';
...
$string['stackBlock_parsons_invalid_columns_value'] = 'Der Wert von \'columns\' im Header des Parsons-Blocks sollte eine Zeichenkette sein, die eine positive ganze Zahl enthält.';
$string['stackBlock_parsons_invalid_item-height_value'] = 'Der Wert von \'item-height\' im Header des Parsons-Blocks sollte eine Zeichenkette sein, die eine positive ganze Zahl enthält.';
$string['stackBlock_parsons_invalid_item-width_value'] = 'Der Wert von \'item-width\' im Header des Parsons-Blocks sollte eine Zeichenkette sein, die eine positive ganze Zahl enthält.';
$string['stackBlock_parsons_invalid_rows_value'] = 'Der Wert von \'rows\' im Header des Parsons-Blocks sollte eine Zeichenkette sein, die eine positive ganze Zahl enthält.';
...
$string['stackBlock_parsons_underdefined_grid'] = 'Wenn Sie für einen Parsons-Block "rows" definieren, müssen Sie auch "columns" definieren.';
$string['stackBlock_parsons_unknown_mathjax_version'] = 'Der Parsons-Block unterstützt nur MathJax-Versionen {$a->mjversion}. Bitte überprüfen Sie Ihre Admin-Einstellungen für die MathJax-Version.';
...
$string['stackBlock_proof_mode_index'] = 'Die Verwendung von \'index\' wird bei der Verwendung des Parson-Blocks zur Überprüfung von Beweisen nicht unterstützt.';
...
$string['stackCas_baddotdot'] = 'Die Verwendung der Matrixmultiplikation "." mit skalaren Fließkommazahlen ist nicht zulässig. Bitte verwenden Sie für das gleiche Ergebnis stattdessen die normale Multiplikation "*".';
$string['stackCas_bracketsdontmatch'] = 'Die Klammern im Ausdruck sind falsch verschachtelt: {$a->cmd}.';
$string['stackCas_chained_inequalities'] = 'Sie scheinen "verkettete Ungleichheiten" zu haben, z. B. \\(a {$a->op} b {$a->op} c\\).  Sie müssen einzelne Ungleichungen mit logischen Operationen wie \\(and\\) oder \\(or\\) verbinden.';
...
$string['stackCas_nested_function_declaration'] = 'Die Definition einer Funktion innerhalb einer anderen Funktion ist nicht mehr zulässig. Bitte benennen Sie die Funktion um, wenn Sie Definitionen von Funktionen aus einer anderen Funktion heraus ändern müssen.';
...
$string['stackCas_overlyComplexSubstitutionGraphOrRandomisation'] = 'Der Fragencode enthält zu komplexe Substitutionen oder baut eine schrittweise und schwer zu validierende Randomisierung ein. Bei der Validierung hat es einen Time-out gegeben. Um dieses Problem zu beheben, vereinfachen Sie die Logik und lesen Sie die Dokumentation für weitere Hinweise.';
...
$string['stackDoc_AnswerTestResults'] = 'Ergebnisse der Antwortüberprüfungen

Auf dieser Seite werden die Ergebnisse der Antwortüberprüfungen für STACK-Testfälle angezeigt. Diese Seite wird automatisch aus den STACK-Unit-Tests generiert und soll den Autor/innen von Fragen veranschaulichen, was Antwortüberprüfungen tatsächlich tun. Dazu gehören auch Fälle, in denen Antwortüberprüfungen derzeit fehlschlagen, was zu einer negativen erwarteten Punktzahl (Score) führt. Kommentare und weitere Testfälle sind sehr willkommen.';
...
$string['stackDoc_docs_desc'] = 'The <a href="{$a->link}">Dokumentation von STACK</a>: Ein lokales, statisches Wiki, in dem der Code dokumentiert wird, der tatsächlich auf Ihrem Server läuft.';
...
$string['stackDoc_siteMap_en'] = 'Sitemap (Englisch)';
...
$string['stackInstall_testsuite_intro'] = 'Auf dieser Seite können Sie Beispiele für STACK-Antwortüberprüfungen sehen und testen, ob Antwortüberprüfungen korrekt funktionieren. Beachten Sie, dass über das Webinterface nur Antwortüberprüfungen getestet werden können.  Ist die Bewertung negativ, deutet dies auf einen erwarteten Fail des Tests hin, wobei -1 bedeutet, dass es einen Fehler aufgrund eines erwarteten internen Fehlers gibt.';
$string['stackInstall_testsuite_nodeployedseeds'] = 'Fragen mit zufälligen Varianten, aber ohne eingesetzte Seeds';
...
$string['stack_library_instructions_three'] = 'Klicken Sie auf "Importieren", um die Frage in die aktuelle Fragenkategorie zu importieren. Alternativ können Sie auf "Ordner importieren" klicken, um alle Fragen im aktuellen Ordner zu importieren.';
$string['stack_library_instructions_two'] = 'Bitte beachten Sie, dass die Tags <code>[[feedback:????]]</code> im Fragetext absichtlich nicht ersetzt, sondern beibehalten werden, um die Position des PRT-Feedbacks zu kennzeichnen.';
...
$string['syntaxattribute_help'] = 'Der Syntax-Hinweis erscheint entweder als veränderbarer <em>Wert</em> oder als nicht-veränderbarer <em>Platzhalter</em>.';
...
$string['testinputsimpwarning'] = 'Bitte beachten Sie, dass Testeingaben unabhängig von der Frage oder der Einstellung der PRT-Option immer <em>unvereinfacht</em> sind.  Bitte verwenden Sie <tt>ev(...,simp)</tt>, um die Ausdrücke der Testeingaben teilweise oder vollständig zu vereinfachen.';
...
$string['versionwarning'] = 'Dadurch wird die Frage auf den neuesten Stand gebracht. Wenn Sie möchten, dass Ihre Änderungen in einer neuen Version der Frage übernommen werden, speichern Sie die Frage bitte im <a href="{$a->url}">Bearbeitungsformular für die Frage</a>, bevor Sie diese Seite absenden.';
