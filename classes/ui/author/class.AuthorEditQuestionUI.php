...
class AuthorEditQuestionUI
{
    ...
    public static function show(array $data, ilPlugin $plugin_object): array
    {
        ...
        try {
            ...
            //get sections
            $content = [
                'ilias_question' => self::getIliasQuestionSection($data, $plugin_object),
                'options' => self::getOptionsSection($data, $plugin_object),
                'inputs' => self::getInputsSection($data, $plugin_object)
            ];
    ...
    /**
     * Gets the ilias question section
     * as legacy form
     */
    private static function getIliasQuestionSection(array $data, ilPlugin $plugin_object): Section
    {
