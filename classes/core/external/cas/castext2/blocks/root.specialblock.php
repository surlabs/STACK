...
use classes\core\external\cas\castext2\castext2_block_factory;
use classes\core\external\cas\castext2\castext2_processor;
use classes\core\external\cas\castext2\CTP_IOBlock;
...
use classes\core\external\cas\castext2\CTP_String;
...
class stack_cas_castext2_special_root extends stack_cas_castext2_block {
    public function compile($format, $options):  ? MP_Node {
        ...
        if (count($errors) > 0) {
            ...
            throw new StackException(implode('; ', $errors));
        }
