...
class castext2_evaluatable implements cas_raw_value_extractor {
    ...
    public function get_evaluationform(): string {
        if ($this->compiled === null) {
            if (!$this->get_valid()) {
                throw new StackException('trying to get evaluation form of invalid castext');
            }
        }
