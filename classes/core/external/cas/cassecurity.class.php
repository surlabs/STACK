...
class stack_cas_security {
    ...
    public function __construct($units = false, $allowedwords = '', $forbiddenwords = '', $forbiddenkeys = array()) {
        ...
        if (!is_bool($this->units)) {
            throw new StackException('stack_cas_security: units must be a bool.');
        }
        if (!is_string($this->allowedwords)) {
            throw new StackException('stack_cas_security: allowedwords must be a string.');
        }
        if (!is_string($this->forbiddenwords)) {
            throw new StackException('stack_cas_security: forbiddenwords must be a string.');
        }
        ...
        if (!is_array($this->forbiddenkeys)) {
            throw new StackException('stack_cas_security: forbiddenkeys must be an array.');
        }
