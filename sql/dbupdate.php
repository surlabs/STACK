...
if (!$db->fetchAssoc($result)) {
	...
	$connection_default_values = array('platform_type' => 'server', 'maxima_version' => '5.44.0', 'cas_connection_timeout' => '5', 'cas_result_caching' => 'db', 'maxima_command' => '', 'plot_command' => '', 'cas_debugging' => '0');
...
if ($db->tableExists("xqcas_configuration")) {
    ...
    if (!in_array("cache_parsed_expressions_longer_than", $existing_entries)) {
        $db->insert("xqcas_configuration", array("parameter_name" => array("text", "cache_parsed_expressions_longer_than"), "value" => array("clob", ""), "group_name" => array("text", "server")));
    }
